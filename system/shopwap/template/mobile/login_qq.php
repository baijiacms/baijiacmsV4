...
<style type="text/css">
    ...
    <div class="title" style="color: #fff;text-align:center;">QQ快捷登陆</div>
</div>
 
    <div style="text-align:center;">
    	<div style="height: 30px;">
                    </div>
  <img src="<?php echo RESOURCE_ROOT;?>public/image/qqlogin.png" style="width: 25%;vertical-align: middle;">
    ...
    <div style="height: 40px;">
        ...
        <div style="text-align: -webkit-center;">
                      ...
                      <div class="balance_sub0" style="width:90%;padding:0px 2%;margin:auto;margin-top:20px " onclick="location.href='<?php echo create_url('mobile',array('act' => 'qq','do' => 'fastlogin'));?>'">QQ安全登录</div>
                        </div>
