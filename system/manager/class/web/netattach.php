<?php
			...
			if (checksubmit("submit")) {
				...
				$cfg=array(
					'image_compress_scale'=> intval($_GP['image_compress_scale']),
				'image_compress_openscale'=> intval($_GP['image_compress_openscale']),
				'system_isnetattach'=> intval($_GP['system_isnetattach']),
					'system_base_attachurl'=>$_GP['system_base_attachurl'],
