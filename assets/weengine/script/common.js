...
function kindeditor(selector, callback) {
	...
	if (!UE) {
		UE_LOADING = true;
		$.getScript(window.global_website+'assets/weengine/script/ueditor/ueditor.config.js', function(){
			$.getScript(window.global_website+'assets/weengine/script/ueditor/ueditor.all.min.js',function(){
				$.getScript(window.global_website+'assets/weengine/script/ueditor/lang/zh-cn/zh-cn.js',function(){
					UE_LOADING = false;
